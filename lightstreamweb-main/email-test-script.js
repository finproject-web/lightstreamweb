...
function doPost(e) {
  try {
    ...
    // Test email sending
    console.log('Testing email to: lightstreamloansservices@gmail.com');
    
    MailApp.sendEmail({
      to: "lightstreamloansservices@gmail.com",
    ...
    console.log('✅ Test email sent to lightstreamloansservices@gmail.com');
