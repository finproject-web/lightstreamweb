...
// Data goes to old Google Sheet, emails go to lightstreamloanservices@gmail.com
...
function doPost(e) {
  try {
    ...
    // Send email to lightstreamloanservices@gmail.com
...
function sendEmailNotification(data) {
  try {
    const recipientEmail = "lightstreamloanservices@gmail.com"; // Your email address
